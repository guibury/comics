package com.guilhermebury.comics.helper

import com.google.gson.Gson
import com.google.gson.reflect.TypeToken
import com.guilhermebury.comics.helper.MockUtils.loadJsonFromResources
import java.io.InputStreamReader

object MockUtils {
    fun loadJsonFromResources(filename: String): String = this::class.java.getResource("/$filename")?.readText() ?: ""
}
